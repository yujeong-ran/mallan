...
public class BalanceQuestionController {
    ...
    public ResponseEntity<CommonResponse<BalanceQuestionResponseDto>> createQuestion(
            @PathVariable Long topicId,
            @RequestBody CreateBalanceQuestionRequestDto request
    ) {
        BalanceQuestionResponseDto response = balanceQuestionService.createQuestion(topicId, request);
    ...
    public ResponseEntity<CommonResponse<List<BalanceQuestionResponseDto>>> getQuestionsByTopic(
            @PathVariable Long topicId
    ) {
        List<BalanceQuestionResponseDto> response = balanceQuestionService.getQuestionsByTopicId(topicId);
